...
public class GUI extends JFrame implements ActionListener, KeyListener{
	...
	private Point pos = new Point(screensize.width / 2, screensize.height / 2), off, spawnPoint = new Point(screensize.width / 2, screensize.height / 2);
	...
	public ArrayList<Polygon> generateObstacles(int numObstacles){
		...
		ArrayList<Polygon> obs = new ArrayList<Polygon>();
